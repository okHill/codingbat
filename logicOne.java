public class logicOne {
    ...
    public boolean nearTen(int num) {
        if ((num % 10 == 2) || (num % 10 == 8) || (num % 10 == 9) || (num % 10 == 1) || (num % 10 == 0)) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean answerCell(boolean isMorning, boolean isMom, boolean isAsleep) {
        return (isMorning && !isAsleep && isMom) || (!isMorning && !isAsleep);
    }
    ...
    public String fizzString(String str) {
        // Alternate solution using substring and equals
    ...
    public boolean inOrderEqual(int a, int b, int c, boolean equalOk) {
        return (b > a && c > b && !equalOk) || (b >= a && c >= b && equalOk);
    }
